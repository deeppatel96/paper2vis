...
export default function UploadPage() {
  ...
  const [maxConcepts, setMaxConcepts] = useState(8);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const job = await submitJob(file, { maxConcepts, quality, figureContext, parallelConcepts, maxRetries, voice, generationMode, conceptSelection });
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-3 rounded-xl bg-gray-900 border border-gray-700 p-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <input type="range" min={1} max={16} value={maxConcepts}
            ...
            <div className="flex items-center gap-4">
              ...
              <input type="range" min={1} max={4} value={parallelConcepts}
